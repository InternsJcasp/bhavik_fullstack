...
// Approach: Search for Target in array from Left to Right and when you got target for first time returns its index.
...
// let findTargetElementIndexFirstOccurrence = (inputArray, targetElement) => {
//   for (i = 0; i <= inputArray.length - 1; i++) {
//     if (inputArray[i] === targetElement) {
//       return `${targetElement}'s is first occurring at ${i} index`;
//     }
//   }
//   return `${targetElement} not found`;
// };

// console.log(findTargetElementIndexFirstOccurrence(array, targetElement));
...
const findTargetElementIndexFirstOccurrence = (inputArray, targetElement) => {
  let left = 0;
  ...
  if (resultIndex !== -1) {
    return `${targetElement}'s is first occurring at ${resultIndex} index`;
  } else {
    return `${targetElement} not found`;
  }
};
